...
(10, 'ปวช', '64209010038', 'ชนากานต์', 'พงษ์สุทธิ์', 'ชาย', 2, '3', 'เทคโนโลยีสารสนเทศ', 1, '64209010038.png'),
(11, 'ปวช', '64209010042', 'ศิวนาถ', 'ธนทรัพย์อำไพ', 'ชาย', 2, '3', 'เทคโนโลยีสารสนเทศ', 0, '64209010042.png'),
(12, 'ปวช', '64209010002', 'ศุภนิมิต', 'พยัคฆพงศ์', 'ชาย', 1, '3', 'เทคโนโลยีสารสนเทศ', 1, ''),
(13, 'ปวช', '64209010003', 'ศรยุทธ', 'ทองใส', 'ชาย', 1, '3', 'เทคโนโลยีสารสนเทศ', 1, ''),
(14, 'ปวช', '64209010004', 'กฤษฏ์', 'ถาวโร', 'ชาย', 1, '3', 'เทคโนโลยีสารสนเทศ', 1, ''),
(15, 'ปวช', '64209010005', 'มนัญชัย', 'น้อยไทย', 'ชาย', 1, '3', 'เทคโนโลยีสารสนเทศ', 1, ''),
(16, 'ปวช', '64209010006', 'อรุณรัตน์', 'ประชานันท์', 'หญิง', 1, '3', 'เทคโนโลยีสารสนเทศ', 1, ''),
(17, 'ปวช', '64209010007', 'กิติศักดิ์', 'ศรีนามหวด', 'ชาย', 1, '3', 'เทคโนโลยีสารสนเทศ', 1, ''),
...
(4, 'ประกาศวิทยาลัยเทคนิคอุดรธานี เรื่อง กำหนดการลงทะเบียนรายวิชา ภาคเรียนที่ 2 ประจำปีการศึกษา 2566', 'ประกาศวิทยาลัยเทคนิคอุดรธานี เรื่อง กำหนดการลงทะเบียนรายวิชา ภาคเรียนที่ 2 ประจำปีการศึกษา 2566', '2566', 1, '0000-00-00', '');
...
--
-- Table structure for table `form_budget_approval`
--

CREATE TABLE `form_budget_approval` (
  `fba_id` int(11) NOT NULL,
  `fba_name` varchar(255) DEFAULT NULL,
  `fba_lname` varchar(255) NOT NULL,
  `fba_position` varchar(255) DEFAULT NULL,
  `fba_with_person` varchar(255) DEFAULT NULL,
  `fba_details` varchar(255) DEFAULT NULL,
  `fba_location` varchar(255) DEFAULT NULL,
  `fba_province` varchar(255) DEFAULT NULL,
  `fba_amphure` varchar(255) DEFAULT NULL,
  `fba_budget` varchar(255) DEFAULT NULL,
  `fba_vehicles` varchar(255) DEFAULT NULL,
  `fba_comment` varchar(255) DEFAULT NULL,
  `fba_o_approve` varchar(2) DEFAULT NULL,
  `startdate` varchar(255) NOT NULL,
  `enddate` varchar(255) NOT NULL,
  `fba_status` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `form_budget_approval`
--

INSERT INTO `form_budget_approval` (`fba_id`, `fba_name`, `fba_lname`, `fba_position`, `fba_with_person`, `fba_details`, `fba_location`, `fba_province`, `fba_amphure`, `fba_budget`, `fba_vehicles`, `fba_comment`, `fba_o_approve`, `startdate`, `enddate`, `fba_status`) VALUES
(3, 'กิตติชัย', 'รักษาวงค์', 'ผู้ช่วย', 'คณะครูแผนกวิชาเทคโนโลยีสารสนเทศ', 'ขออนุญาตินำนักศึกษาไปแข่งขันทักษะวิชาชีพ', 'เทคนิคอุบล', '23', 'เมือง', '1', '1', '1', '1', '2023-08-28', '2023-08-30', 1);
...
(1, '3626299495765', 'EDS0001', 'kittichai@eds.ac.th', '123', 'กิตติชัย', 'รักษาวงค์', '   วิทยาลัยเทคนิคอุดรธานี', '0959611962', '13/04/2548', 1, '0', 0, 'EDS-1.png'),
...
--
-- Indexes for table `form_budget_approval`
--
ALTER TABLE `form_budget_approval`
...
--
ALTER TABLE `districts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=961304;
...
--
ALTER TABLE `files`
  MODIFY `filesID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `form_budget_approval`
--
ALTER TABLE `form_budget_approval`
  MODIFY `fba_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

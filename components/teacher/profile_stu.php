...
<div class="w-full  bg-[#f7f8f9] p-4">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="#ff8e00" stroke-width="2" stroke-linecap="butt" stroke-linejoin="arcs"><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8l-6-6z"/><path d="M14 3v5h5M16 13H8M16 17H8M10 9H8"/></svg>ข้อมูลนักศึกษา</span>
                ...
                <div class="flex justify-center">
                    <div class="avatar mt-4">
                        <div class="w-[230px] h-[270px] rounded">
                            <img src="https://inwfile.com/s-fz/v5pbz6.jpg" />
                        </div>
                    </div>
                </div>
                <div class="flex flex-col items-center mt-4">
                    <span class="text-[20px] font-medium">นายบงกชเพชร ยอดกระโทก</span>
                    <span class="text-gray-500">64209010033</span>
...
<ul   class="relative flex flex-col gap-12 py-12 pl-6 before:absolute before:top-0 before:left-6 before:h-full before:border before:-translate-x-1/2 before:border-slate-200 before:border-dashed after:absolute after:top-6 after:left-6 after:bottom-6 after:border after:-translate-x-1/2 after:border-slate-200 ">
  ...
  <table class=" w-full rounded border-slate-200" >
    <tbody>
      ...
      <tr class="transition-colors duration-300 rounded-md hover:bg-slate-50">
        ...
        <td class="h-12 px-4 text-sm text-left transition duration-300 border-t border-l  first:border-l-0  border-slate-200 stroke-slate-500 text-slate-500 ">64209010033</td>
      ...
      <tr class="transition-colors duration-300 rounded-md hover:bg-slate-50">
        ...
        <td class="h-12 px-4 text-sm text-left transition duration-300 border-t border-l  first:border-l-0  border-slate-200 stroke-slate-500 text-slate-500 ">บงกชเพชร ยอดกระโทก</td>
      ...
      <tr class="transition-colors duration-300 rounded-md hover:bg-slate-50">
        ...
        <td class="h-12 px-4 text-sm text-left transition duration-300 border-t border-l  first:border-l-0  border-slate-200 stroke-slate-500 text-slate-500 ">อาร์ต</td>
      ...
      <tr class="transition-colors duration-300 rounded-md hover:bg-slate-50">
        ...
        <td class="h-12 px-4 text-sm text-left transition duration-300 border-t border-l  first:border-l-0  border-slate-200 stroke-slate-500 text-slate-500 ">1122334455</td>
      ...
      <tr class="transition-colors duration-300 rounded-md hover:bg-slate-50">
        ...
        <td class="h-12 px-4 text-sm text-left transition duration-300 rounded-bl-lg border-t border-l  first:border-l-0  border-slate-200 stroke-slate-500 text-slate-500 ">022-022-02222</td>
  ...
  <table class=" w-full mt-4 rounded border-slate-200" >
    ...
    <tr class="transition-colors duration-300 rounded-md hover:bg-slate-50">
        ...
        <td class="h-12 px-4 text-sm text-left transition duration-300 border-t border-l  first:border-l-0  border-slate-200 stroke-slate-500 text-slate-500 ">ประกาศนียบัตรวิชาชีพ</td>
      ...
      <tr class="transition-colors duration-300 rounded-md hover:bg-slate-50">
        ...
        <td class="h-12 px-4 text-sm text-left transition duration-300 rounded-bl-lg border-t border-l  first:border-l-0  border-slate-200 stroke-slate-500 text-slate-500 ">ยังศึกษาอยู่</td>

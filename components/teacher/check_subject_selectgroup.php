  ...
  <table class="w-full text-left border border-separate rounded border-slate-200" cellspacing="0">
    <tbody>
      ...
      <tr class="transition-colors duration-300 hover:bg-slate-50" a>
        ...
        <td class="h-12 px-1 text-sm transitions duration-300 border-t border-l first:border-l-0 border-slate-200 stroke-slate-500 text-slate-500 "><a href="./check_subject_date.php?=<?php echo $row['schedule_classYears']. "/" . $row['schedule_classGroup'] . "" . $row['schedule_title'];?> ?>" class=" ml-auto flex items-center" type="">

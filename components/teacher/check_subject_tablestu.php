...
<div class="flex justify-center px-24 items-center">
        ...
        <div class="w-full overflow-x-auto">
            <div class="flex py-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="#ff8e00" stroke-width="2" stroke-linecap="butt" stroke-linejoin="arcs"><polygon points="14 2 18 6 7 17 3 17 3 13 14 2"></polygon><line x1="3" y1="22" x2="21" y2="22"></line></svg>
            <span class="text-[24px] font-medium">บันทึกการเช็คชื่อ</span>
            </div>
            <div class="flex gap-4 mb-4">
                <span class="flex text-[16px] font-medium gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#ff8e00" stroke-width="2" stroke-linecap="butt" stroke-linejoin="arcs"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>    
                วันที่เรียน : 20/7/2025 </span>
                <span class="flex text-[16px] font-medium gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#13de6d" stroke-width="2" stroke-linecap="butt" stroke-linejoin="arcs"><polygon points="16 3 21 8 8 21 3 21 3 16 16 3"></polygon></svg>    
                คาบทฤษฏี</span>
                        ...
                        <td class="h-16 px-6 text-sm transition duration-300 border-t border-l first:border-l-0 border-slate-200 stroke-slate-500 text-slate-500 ">
                            <div class="flex py-4">
                                <div>
                                    <div class="avatar">
                                        <div class="w-[120px] h-[130px] rounded-xl">
                                            <img src="https://fandomkpop.com/wp-content/uploads/2022/07/Hanni-NewJeans.webp" />
                                        </div>
                                    </div>
                        ...
                        <td class="h-16 px-6 text-sm transition duration-300 border-t border-l first:border-l-0 border-slate-200 stroke-slate-500 text-slate-500 ">
                            <div class="flex py-4">
                                <div>
                                    <div class="avatar">
                                        <div class="w-[120px] h-[130px] rounded-xl">
                                            <img src="https://i0.wp.com/dudeplace.co/wp-content/uploads/2023/02/chiquita.jpg?fit=801%2C531&ssl=1" />
                                        </div>
                                    </div>
       ...
       <div class="mt-4">
       <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="inline-flex items-center  justify-center h-12 gap-2 px-6 text-sm font-medium tracking-wide text-white transition duration-300 rounded focus-visible:outline-none whitespace-nowrap bg-emerald-500 hover:bg-emerald-600 focus:bg-emerald-700 disabled:cursor-not-allowed disabled:border-emerald-300 disabled:bg-emerald-300 disabled:shadow-none">
      <span>บันทึก</span>
    </button>
       </div>

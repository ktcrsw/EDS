...
<!-- Page Container -->
<div class="d-flex  items-center justify-content-center  content-center p-100">
...
<div class="flex flex-col mt-0">
    ...
    <div class="container max-w-7xl px-4">
        ...
        <!-- Team Members -->
        <div class="flex p-100">
            <!-- Member #1 -->
            <div class="w-full md:w-6/12 lg:w-3/12 mb-6 px-6 sm:px-6 lg:px-4 p-100">
                <div class="">
                    <!-- Avatar -->

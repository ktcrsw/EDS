...
/*                                student card                                */
/* -------------------------------------------------------------------------- */ -->
<div class="w-[50%] ml-[10px] rounded-[10px] flex justify-center py-4   bg-slate-300">
<div
  class="block w-[502px]   rounded-lg h-[323px]  bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:border-primary-300 dark:bg-neutral-600">
  <div
    class="  px-6 bg-[#689ae3] rounded-t-lg flex justify-center items-center   h-[57px] text-neutral-600 ">
    <span class="text-white text-[49px] tracking-widest font-bold">STUDENT</span>
  </div>
  <div class="block w-full  h-[266px] rounded-b-lg bg-white bg-cover shadow-lg dark:bg-neutral-700"
  style="background-image: url('./EDS.png');">
  <div class="flex">
<div class="h-[266px]">
...
<div class="w-full h-[205px] ">
  ...
  <div class="w-1/2  bg-red-300 rounded-bl-lg h-44"></div>
  <div class="w-1/2  bg-red-300 rounded-br-lg h-44"></div>
  </div> -->
...
<table class="w-full pt-2 text-center border border-separate rounded border-slate-200" cellspacing="0">
   ...
   <a href="./score_greenAdd.php"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 ml-2" viewBox="0 0 24 24" fill="none" stroke="#ea860c" stroke-width="3" stroke-linecap="butt" stroke-linejoin="arcs"><polygon points="16 3 21 8 8 21 3 21 3 16 16 3"></polygon></svg></a>
        </th>
    </div>

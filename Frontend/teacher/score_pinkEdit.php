...
<div class="px-4">
<a href="./score_pinkAdd.php" class="px-10 py-4 bg-blue-500 text-white">เพิ่มใบงาน</a>
...
<div class="w-full px-4 py-3 text-sm border text-center rounded border-cyan-100 bg-cyan-500 text-white" role="alert">
  <p>ใบงาน/ภาคทฤษฏี หน่วยการเรียนที่ 1 (20คะแนน)</p>
</div>
<table class="w-full pt-2 text-center border border-separate rounded border-slate-200" cellspacing="0">
    ...
    <div class="flex  justify-center">
      <label for="" class="text-sm font-medium  "> คะแนน</label>
   <a href="./score_pinkAdd.php"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 ml-2" viewBox="0 0 24 24" fill="none" stroke="#ea860c" stroke-width="3" stroke-linecap="butt" stroke-linejoin="arcs"><polygon points="16 3 21 8 8 21 3 21 3 16 16 3"></polygon></svg></a>
        </th>
    </div>
